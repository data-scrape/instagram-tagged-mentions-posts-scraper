...
**Instagramtaggedmentionspostsscraper** — Scrape instagram tagged mentions posts scraper data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/instagram-tagged-mentions-posts-scraper?style=social)
...
`instagram-tagged-mentions-posts-scraper` is an implementation-focused Python project for collecting public instagram-tagged-mentions-posts-scraper data. It is designed around one practical job: turn a query such as **"AI productivity"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/instagram-tagged-mentions-posts-scraper.git
cd instagram-tagged-mentions-posts-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "instagram-tagged-mentions-posts-scraper", "category": "Custom Scrapers"}
  }
}
```
